...
// Query: *[_type == "video" && url in $urls]{    url,    durationSeconds,    "chapters": chapters[startSeconds in $seconds]{startSeconds, label},    "chunks": chunks[startSeconds in $seconds]{startSeconds}  }
